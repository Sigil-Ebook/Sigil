...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/gperf -m100 -n ./foreign_attrs.gperf  */
...
const ForeignAttrReplacement * gumbo_get_foreign_attr_replacement (const char * str, size_t len)
{
