...
static const QString NAV_PAGELIST_PATTERN = "<!--\\s*SIGIL_REPLACE_PAGELIST_HERE\\s*-->";
static const QString NAV_LANDMARKS_PATTERN = "<!--\\s*SIGIL_REPLACE_LANDMARKS_HERE\\s*-->";
static const QString NAV_TOC_PATTERN = "<!--\\s*SIGIL_REPLACE_TOC_HERE\\s*-->";
