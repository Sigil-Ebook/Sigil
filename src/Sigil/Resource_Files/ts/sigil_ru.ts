...
&lt;p style=&quot;margin-left: 0.5em;&quot;&gt;Go back to the last link you clicked or back to where you used Go to Link or Style.&lt;/p&gt;
    ...
    <message>
        ...
        <translation>Проверять на ошибки оформления</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;p&gt;Запрошенная операция не может быть выполнена, поскольку &lt;b&gt;%1&lt;/b&gt; не является правильно оформленным документом XML.&lt;/p&gt;&lt;p&gt;Обнаружена ошибка в &lt;b&gt;строке %2, столбце %3: %4.&lt;/b&gt;&lt;/p&gt;&lt;p&gt;Выбрав вариант &lt;i&gt;Исправить вручную&lt;/i&gt;, вы сможете самостоятельно исправить допущенную ошибку. &lt;/p&gt;&lt;p&gt;Вариант &lt;i&gt;Исправить автоматически&lt;/i&gt; запустит автокорректор. &lt;b&gt;Внимание: работа автокорректора может привести к потере данных!&lt;/b&gt;&lt;/p&gt;</translation>
    </message>
    <message>
