...
class CSSPageRule(cssrule.CSSRuleRules):
    ...
    def __repr__(self):
        return "css_parser.css.%s(selectorText=%r, style=%r)" % (
    ...
    def _getCssText(self):
        ...
        return css_parser.ser.do_CSSPageRule(self)
    ...
    def _getSelectorText(self):
        """Wrapper for css_parser Selector object."""
        return css_parser.ser.do_CSSPageRuleSelector(self._selectorText)
    ...
    def _setStyle(self, style):
        ...
        """
        self._checkReadonly()
        # Under Python2.x this was basestring but given unicode literals ...
        if isinstance(style, string_type):
    ...
    def insertRule(self, rule, index=None):
        ...
        if isinstance(rule, css_parser.css.CSSCharsetRule) or \
           ...
           isinstance(rule, css_parser.css.CSSMediaRule):
