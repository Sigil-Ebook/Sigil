...
class CSSStyleDeclaration(CSS2Properties, css_parser.util.Base2):
    ...
    def _delP(self, CSSName):
        """(css_parser only) Overwritten here and effectively the same as
    ...
    def _getCssText(self):
        ...
        return css_parser.ser.do_css_CSSStyleDeclaration(self)
    ...
    def getCssText(self, separator=None):
        ...
        :returns:
            ...
            separator!
        """
        return css_parser.ser.do_css_CSSStyleDeclaration(self, separator)
...
#            x.parent = self
    ...
    def getProperties(self, name=None, all=False):
        ...
        :param all:
            ...
            stylesheet.
        :returns:
            a list of :class:`~css_parser.css.Property` objects set in
            this declaration.
        """
        if name and not all:
    ...
    def getProperty(self, name, normalize=True):
        ...
        :returns:
            the effective :class:`~css_parser.css.Property` object.
        """
        nname = self._normalize(name)
        found = None
        for item in reversed(self.seq):
    ...
    def getPropertyCSSValue(self, name, normalize=True):
        ...
        :param normalize:
            ...
            effective for the unnormalized name.
        :returns:
            :class:`~css_parser.css.CSSValue`, the value of the effective
        ...
        **css_parser currently always returns a CSSValue if the property is
        set.**
    ...
    def setProperty(self, name, value=None, priority='',
        ...
        :param name:
            ...
            css_parser also allowed `name` to be a
            :class:`~css_parser.css.Property` object, all other
