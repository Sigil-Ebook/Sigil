...
class PropertyValue(css_parser.util._NewBase):
    """
    ...
    def __len__(self):
        return len(as_list(self.__items()))

    def __getitem__(self, index):
        try:
            return as_list(self.__items())[index]
        except IndexError:
            return None
    ...
    def __repr__(self):
        return "css_parser.css.%s(%r)" % (self.__class__.__name__, self.cssText)

    def __str__(self):
        return "<css_parser.css.%s object length=%r cssText=%r at "\
    ...
    cssText = property(lambda self: css_parser.ser.do_css_PropertyValue(self),
                       _setCssText,
    ...
    value = property(lambda self: css_parser.ser.do_css_PropertyValue(self, valuesOnly=True),
                     doc="A string representation of the current value "
                     "without any comments used for validation.")


class Value(css_parser.util._NewBase):
    """
    ...
    def __str__(self):
        return "<css_parser.css.%s object type=%s value=%r cssText=%r at 0x%x>"\
    ...
    cssText = property(lambda self: css_parser.ser.do_css_Value(self),
                       _setCssText,
    ...
    type = property(lambda self: self._type,  # _setType,
                    doc="Type of this value, for now the production type "
                        ...
                        "defined as constants in :class:`~css_parser.css.Value`.")
...
class ColorValue(Value):
    ...
    def __str__(self):
        return "<css_parser.css.%s object type=%s value=%r colorType=%r "\
    ...
    cssText = property(lambda self: css_parser.ser.do_css_ColorValue(self),
                       _setCssText,
                       doc="String value of this value.")

    value = property(lambda self: css_parser.ser.do_css_CSSFunction(self, True),
    ...
    def _getName(self):
        for n, v in as_list(self.COLORS.items()):
...
class DimensionValue(Value):
    ...
    def __str__(self):
        return "<css_parser.css.%s object type=%s value=%r dimension=%r cssText=%r at 0x%x>"\
               % (self.__class__.__name__,
...
class URIValue(Value):
    ...
    def __str__(self):
        return "<css_parser.css.%s object type=%s value=%r uri=%r cssText=%r at 0x%x>"\
               % (self.__class__.__name__,
...
class CSSFunction(Value):
    ...
    cssText = property(lambda self: css_parser.ser.do_css_CSSFunction(self),
                       _setCssText,
                       doc="String value of this value.")
...
class MSValue(CSSFunction):
    ...
    cssText = property(lambda self: css_parser.ser.do_css_MSValue(self),
                       _setCssText,
                       doc="String value of this value.")
...
class CSSCalc(CSSFunction):
    ...
    def __str__(self):
        return "<css_parser.css.%s object at 0x%x>" % (
    ...
    cssText = property(lambda self: css_parser.ser.do_css_CSSCalc(self),
...
class CSSVariable(CSSFunction):
    ...
    def __str__(self):
        return "<css_parser.css.%s object name=%r value=%r at 0x%x>" % (
    ...
    cssText = property(lambda self: css_parser.ser.do_css_CSSVariable(self),
